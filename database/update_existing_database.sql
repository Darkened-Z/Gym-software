...
ALTER TABLE members_men
    ...
    ADD COLUMN IF NOT EXISTS locker_fee DECIMAL(10, 2) DEFAULT 0.00,
    ADD COLUMN IF NOT EXISTS next_fee_due_date DATE NULL,
    ADD COLUMN IF NOT EXISTS total_due_amount DECIMAL(10, 2) DEFAULT 0.00,
    ADD COLUMN IF NOT EXISTS nfc_uid VARCHAR(20) NULL,
    ADD COLUMN IF NOT EXISTS rfid_uid VARCHAR(20) NULL,
    ADD COLUMN IF NOT EXISTS rfid_assigned_date DATETIME NULL,
    ADD COLUMN IF NOT EXISTS status ENUM('active', 'inactive') DEFAULT 'active',
    ADD COLUMN IF NOT EXISTS status_force_active TINYINT(1) DEFAULT 0,
    ADD COLUMN IF NOT EXISTS is_checked_in TINYINT(1) DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_member_code ON members_men (member_code);
CREATE INDEX IF NOT EXISTS idx_phone ON members_men (phone);
CREATE INDEX IF NOT EXISTS idx_status ON members_men (status);
CREATE INDEX IF NOT EXISTS idx_next_fee_due_date ON members_men (next_fee_due_date);
CREATE INDEX IF NOT EXISTS idx_nfc_uid ON members_men (nfc_uid);
CREATE INDEX IF NOT EXISTS idx_rfid_uid ON members_men (rfid_uid);
CREATE INDEX IF NOT EXISTS idx_is_checked_in ON members_men (is_checked_in);

CREATE INDEX IF NOT EXISTS idx_member_code ON members_women (member_code);
CREATE INDEX IF NOT EXISTS idx_phone ON members_women (phone);
CREATE INDEX IF NOT EXISTS idx_status ON members_women (status);
CREATE INDEX IF NOT EXISTS idx_next_fee_due_date ON members_women (next_fee_due_date);
CREATE INDEX IF NOT EXISTS idx_nfc_uid ON members_women (nfc_uid);
CREATE INDEX IF NOT EXISTS idx_rfid_uid ON members_women (rfid_uid);
CREATE INDEX IF NOT EXISTS idx_is_checked_in ON members_women (is_checked_in);
...
ALTER TABLE attendance_men
    ADD COLUMN IF NOT EXISTS check_in DATETIME NULL,
    ADD COLUMN IF NOT EXISTS check_out DATETIME NULL,
...
ALTER TABLE payments_men
    ...
    ADD COLUMN IF NOT EXISTS total_due_amount DECIMAL(10, 2) DEFAULT NULL,
    ADD COLUMN IF NOT EXISTS due_date DATE NULL,
    ADD COLUMN IF NOT EXISTS invoice_number VARCHAR(100) NULL,
    ADD COLUMN IF NOT EXISTS payment_type VARCHAR(50) NULL,
    ADD COLUMN IF NOT EXISTS payment_method VARCHAR(50) NULL DEFAULT 'Cash',
    ADD COLUMN IF NOT EXISTS received_by VARCHAR(100) NULL,
    ADD COLUMN IF NOT EXISTS status ENUM('pending', 'completed') DEFAULT 'completed';
...
-- Note: legacy member date handling is already supported in app code.
-- This migration only adds missing structures for current features.

-- ============================================================================
-- Seed data used by the current app
-- ============================================================================
